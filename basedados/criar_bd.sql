...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2025 at 05:01 PM
...
(1, '21232f297a57a5a743894a0e4a801fc3', 'admin', 'Boss', 'Rua Boss Lande ', '100100100', 1, 1, 'boss@mail.com'),
(15, 'cc7a84634199040d54376793842fe035', 'funcionario', NULL, NULL, NULL, 2, 1, ''),
(16, '4983a0ab83ed86e0e7213c8783940193', 'cliente', 'Esteves', 'Rua Landan Paulo', '912345678', 3, 2, 'esteves@mail.com'),
...
(20, '0f759dd1ea6c4c76cedc299039ca4f23', 'leo', 'leo', 'leo', '912345678', 4, 6, 'leo@mail.com');
...
--
ALTER TABLE `bilhete`
  MODIFY `id_bilhete` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `carteira_log`
  MODIFY `id_carteira_log` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `utilizador`
  MODIFY `id_utilizador` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
